...
public class SparkMain {
    public static void main(String[] args) {
        ...
        validRowsRDD.map(row -> "Country: " + row[6]).take(100).forEach(System.out::println);
        ...
        validRowsRDD.map(row -> "Country: " + row[6] + " | Artist: " + row[2]).take(100).forEach(System.out::println);
